...
COLLECTION_NAME = "reservation_HW"
load_dotenv("../.env")

user = os.getenv("user")
password = urllib.parse.quote(os.getenv("password"))

MONGO_DB_URL = f'mongodb://{user}:{urllib.parse.quote(password)}@mongo.exceed19.online:8443/?authMechanism=DEFAULT'   # mongodb://localhost
